...
<%@ page import="com.espeed.pojo.XUser" %>
...
String nowday=dfs.format(new Date());
String type=request.getParameter("type");
if(type!=null&&type.equals("1")){
	savePath+="userimg/signed/";
	saveUrl="../userimg/signed/";
}else{
	ActionContext ac = ActionContext.getContext();
	Map<String,Object> sess = ac.getSession();
	XUser user=(XUser) sess.get("user");
	savePath+="temp/"+nowday+"/";
	saveUrl="../temp/"+nowday+"/";
}
