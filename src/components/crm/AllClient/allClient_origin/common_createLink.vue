    ...
    <div class="createTab">
      ...
      <div class="crm-create-box">
        ...
        <div class="crm-alert-tab">
          <component :is="currentTab" :to-client-list="toClientList" keep-alive></component>
        </div>
      </div>
...
<script>
  import searchClient from './common_changeToLinkMan.vue'
  import newClientByhand from '../../createClient/createClient_newClientByhand.vue'
  export default ({
    name:'createClient',
    data(){
    return {
